...
{
    [Display("Single Serial Pass ", Group: "RjioMRU.TestSteps.MESSteps", Description: "Insert a description here")]
    public class SingleSerialPass : TestStep
    {
        #region Settings
        ...
        {
            var value1 = MesResource.SingleSerialPass(ServerURL.Value, ClientID.Value, EmployeeID.Value, SerialNumber.Value, stageID.Value);
